...
const directoriesToProcess = [
  '/mnt/data/Github/office/Bank/frontend/src/pages/transactions/employee',
  '/mnt/data/Github/office/Bank/frontend/src/pages/transactions/bank',
  '/mnt/data/Github/office/Bank/frontend/src/pages/transactions/other',
  '/mnt/data/Github/office/Bank/frontend/src/pages/transactions/member'
];
