                  ...
                  <div className="absolute right-0 top-full mt-2 w-[320px] sm:w-[400px] z-50 rounded-2xl border border-slate-200 bg-white p-4 shadow-xl">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <input type="date" value={filterDateFrom} onChange={(e) => setFilterDateFrom(e.target.value)} className="w-full rounded-[0.75rem] border border-slate-200 bg-white px-3 h-9 text-[13px] outline-none focus:border-[var(--primary)] focus:ring-1 focus:ring-[var(--primary)] text-slate-700 transition-colors hover:border-slate-300" />
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-[12px] font-semibold text-slate-600">Date To</label>
                        <input type="date" value={filterDateTo} onChange={(e) => setFilterDateTo(e.target.value)} className="w-full rounded-[0.75rem] border border-slate-200 bg-white px-3 h-9 text-[13px] outline-none focus:border-[var(--primary)] focus:ring-1 focus:ring-[var(--primary)] text-slate-700 transition-colors hover:border-slate-300" />
                      </div>
                    </div>
                    <div className="mt-6">
                      <Button
