...
export function DepositPaidMemberTransactionDetailPage() {
  const customTabs = [
    ...
    { id: 'attachments', label: 'Deposit Docs', icon: FileText },
      ...
      return (
        <Card className="rounded-2xl border border-slate-200 bg-white shadow-sm">
          <div className="divide-y divide-slate-100 px-6">
            ...
            <DetailRow label="Deposit Amount" value={formatTransactionAmount(record.amount || 0)} />
  ...
  return (
    <MemberTransactionDetailPage
      sectionKey="member"
      itemKey="deposit-paid-member"
      detailPathBase="/app/transactions/member/deposit-paid"
...
export default DepositPaidMemberTransactionDetailPage;
